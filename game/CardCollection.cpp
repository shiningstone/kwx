...
void CardInHand::_JudgeDaXiaoSanYuan() {
    if(statzhongFaBai[0]>=3&&statzhongFaBai[1]>=3&&statzhongFaBai[2]>=3) {//Â§ß‰∏âÂÖÉ
        _set(statHuFanMask,RH_DASANYUAN);
            ...
            || (statzhongFaBai[0]>=3&&statzhongFaBai[1]==2&&statzhongFaBai[2]>=3) ) {//Â∞è‰∏âÂÖÉ
...
/*BUG???: cards_stable »Áπ˚”–“ª◊È»˝∏ˆªÚ’ﬂÀƒ∏ˆ£¨±ª…æµÙæÕ∫˙≤ª¡À*/
