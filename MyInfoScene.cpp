...
bool MyInfoScene::init()
{
	...
	selectEffectOfInfo->setPosition(Vec2(origin.x+visiableSize.width/2,origin.y+visiableSize.height*669.5/716));
	...
	MyMessage->setPosition(Vec2(origin.x+visiableSize.width/2,origin.y+visiableSize.height*668/716));
